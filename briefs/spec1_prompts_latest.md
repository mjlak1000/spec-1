# SPEC-1 Investigation Prompts — 2026-04-18
Generated: 2026-04-18T22:58:48.662403+00:00
...
### Elevated Signals
[One paragraph per elevated signal. Source. What was observed. Confidence score. What to watch next. If zero elevated signals, say so plainly.]
...
[For each evidence chain, write one paragraph that cites the specific excerpts and sources. Do not just state the pattern fired — show the evidence that triggered it and let the reader judge whether the pattern is real. If no evidence chains exist, write: "No psyop patterns detected this cycle."]
...
Who to call: [Source type — congressional staffer, DoD spokesperson,               CISA, company IR, think tank analyst, etc.]
Documents to request: [FOIA targets, SEC filings, congressional records,                        earnings calls, company disclosures — what is findable]
...
### Signal Notes
[Brief methodological note: source gaps, gate failure patterns, anything that affected today's collection quality. 2-4 sentences.]
